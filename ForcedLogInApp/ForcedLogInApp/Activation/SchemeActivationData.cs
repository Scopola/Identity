...
namespace ForcedLogInApp.Activation
{
    public class SchemeActivationData
    {
        // TODO WTS: Open package.appxmanifest and change the declaration for the scheme (from the default of 'forcedloginapp') to what you want for your app.
        ...
        private const string ProtocolName = "forcedloginapp";
